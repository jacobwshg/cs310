...
class ImageApp(QMainWindow):
    ...
    def setup_gallery_tab(self):
        ...
        btn_delete = QPushButton( "Delete All Images" )
        btn_delete.clicked.connect( self.delete_handler )
    ...
    def setup_upload_tab(self):
        ...
        btn_select_file = QPushButton("Select and Upload Image")
    ...
    def refresh_image_list(self):
        try:
            ...
            for row_idx, (assetid, userid, localname, bucketkey) in enumerate(images):
                ...
                btn_download = QPushButton("Download and Open")
                btn_download.clicked.connect(lambda ch, aid=assetid: self.download_and_display(aid))
                self.table.setCellWidget(row_idx, 5, btn_download)
